#ifndef _AN_TABLE_HASH_H
#define _AN_TABLE_HASH_H
...
/* coverity mocks can't override inline functions, so don't define them */
#ifndef __COVERITY__
...
#if AN_CC_GCC_VERSION_AT_LEAST(4, 6, 0)
#pragma GCC diagnostic push

#if AN_CC_GCC_VERSION_AT_LEAST(4, 8, 0) && !defined(__clang__)
